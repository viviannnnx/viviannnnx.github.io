...
imname = './1/CS180_fa2026_proj1_data/monastery.jpg'
...
def align(base, moving, window=15, metric='l2'):
    best_score = 0
    best_offset = (0, 0)
...
gb_dx, gb_dy = align(b,g)
rb_dx, rb_dy = align(b,r)
...
# save the image
fname = './1/images/single/monastery_l2.jpg'
